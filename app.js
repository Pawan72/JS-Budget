...
var BudgetController = ( function(){
    ...
    //Place where all the data resides
    var data = {
        allItems: {
            exp: [],
            inc: []
    ...
    return{
        ...
        //To add input from User to Data.
        addItem: function(type,des, val){
            var newItem, ID;
            

            //To define the ID of the data
            ...
            //Check the input type either expense or income
            if(type === 'exp'){
...
var UIController = ( function(){
    ...
    //Store all the DOM object Classses
    var DOMstrings = {
        inputType: ".add__type",
